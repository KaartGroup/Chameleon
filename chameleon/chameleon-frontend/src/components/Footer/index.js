    ...
    return (
        <MainFooter>
            <Row>
                ...
                <Column>
                    ...
                    <UI>
                        ...
                        <List>
                            <Link href="https://github.com/KaartGroup/GoKaart">
                                Go Kaart
                            </Link>
                        </List>
                        <List>
                            <Link href="http://chameleon.kaart.com/">
                                Chameleon
                            </Link>
                        </List>
                    </UI>
                ...
                <Column>
                    ...
                    <UI>
                        ...
                        <List>
                            <Link href="https://kaart.com/careers/">
                                Careers
                            </Link>
                        </List>
                    </UI>
            ...
            <SmallRow>
                <SmallColumn>
                    <Copyright>
                        &copy;{new Date().getFullYear()} Kaart Group LLC. All
                        rights reserved.
                    </Copyright>
                </SmallColumn>
                <SmallColumn>
