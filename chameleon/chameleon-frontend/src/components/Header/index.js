            ...
            <Toolbar>
                ...
                <div className="parent-div">
                    <KaartMenuItem>
                        <div className="dropdown">
                            ...
                            <div className="dropdown-content">
                                <a href="https://kaart.com/osm/">
                                    Osm Services
                                </a>
                                <a href="https://kaart.com/gis/">
                                    Gis Consulting
                                </a>
                    ...
                    <KaartMenuItem>
                        <div className="dropdown">
                            <div
                                href="https://kaart.com/tools/"
                                className="dropbtn"
                            >
                                Tools<i className="arrow"></i>
                            </div>
                            <div className="dropdown-content ">
                                <a href="http://chameleon.kaart.com/">
                                    Chameleon
                                </a>
                                <a href="https://gem.kaart.com/">Gem</a>
                                <a href="https://github.com/KaartGroup/GoKaart">
                                    Gokaart
                                </a>
                                <a href="https://simple.kaart.com/">
                                    Simple Gis
                                </a>
                                <a href="https://viewer.kaart.com/login">
                                    Viewer
                                </a>
                            </div>
                        </div>
